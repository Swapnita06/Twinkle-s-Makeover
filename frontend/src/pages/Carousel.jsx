...
const Carousel = () => {
  const imageList = [
    { src: "./images/cool-background (1).png", alt: "Image 3" },
    { src: "./images/jake-peterson-VJ4pn_PSBLo-unsplash.jpg", alt: "Image 1"},
  ...
  return (
    ...
    <div style={{maxWidth: "700px", margin: "0 auto",marginTop: "50px",objectFit:"cover",backgroundColor:"black"}}>
      <Slider {...settings}>
  ...
  backgroundSize: `calc(128px/4.667) 128px, 128px calc(128px/4.667)`
          ,
                overflow: "hidden",
                color: "black",
                cursor: "pointer",
